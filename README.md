...
- **Format Conversion**: Convert images to JPEG, PNG, or WebP on download
...
4. **Use filters** to narrow down by type, resolution, or limit
5. **Select images** by clicking on them or use "Select All"
6. **Choose output format** (Original, JPEG, PNG, or WebP)
7. **Click Download** to save selected images
...
| **Limit** | Slider to limit number of images shown |
| **Output** | Choose output format (Original/JPEG/PNG/WebP) |
...
- `{ProductTitle}_1.png`, `{ProductTitle}_1.webp`, etc.
...
6. **background.js** handles format conversion using Canvas API
7. Download is processed by **background.js** with sequential delays
